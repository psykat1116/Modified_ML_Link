...
def set_params():
    ...
    parser.add_argument("--num_hidden", type=int, default=2, help="Numbers of hidden layers of the GNN.")
    parser.add_argument('--epochs', type=int, default=100, help='Number of epochs.')

    parser.add_argument('--n_heads', type=int, default=1, help='Number of attentions heads of GNN.')
    parser.add_argument('--heads_mode', type=str, default='concat', help='Concatenate (concat) or averaging (avg) the multiple attention heads.')
    parser.add_argument('--predictor', type=str, default="mlp", help='MLP decoder.')
    parser.add_argument('--omn', type=str, default='oan;maan', help='Types of overlapping multilayer neighborhoods. Supported types are oan and maan. Each overlapping multilayer neighborhood must be followed by a semicolon, e.g., oan;maan')
    parser.add_argument('--dropout', type=float, default=0.5, help='Dropout rate.')
    parser.add_argument('--attn_dropout', type=float, default=0.7, help='Attention dropout rate for attention based GNN models.')
    ...
    parser.add_argument('--target_layer', type=int, default=-1, help='1-based layer id to predict/report (e.g., fb-friends). Use -1 to aggregate over all layers.')
    parser.add_argument('--comparison_mode', type=str, default='ours', choices=['mllink', 'ours'])
    parser.add_argument('--removal_frac', type=float, default=0.5)
    parser.add_argument('--temporal', action='store_true')
    parser.add_argument('--n_snapshots', type=int, default=4)
    parser.add_argument('--katz_beta', type=float, default=0.05)
    parser.add_argument('--root', type=str, default='./data/nets/', help='Root directory of input data.')
    parser.add_argument('--save_dir', type=str, default='./artifacts/', help='Folder where the performance scores are saved.')
